...
def _expected_dssp_chain_labels():
    ...
    for idx in range(count):
        if idx < len(alphabet):
            ...
            letters.append(f"{alphabet[idx // 26 - 1]}{alphabet[idx % 26]}")
    return letters
...
def _stage_d1_outputs():
    return (
        [os.path.join(OUTPUT_DIR, "Protein_RMSD.csv")],
        [os.path.join(OUTPUT_DIR, "Protein_RMSD.png")],
        {},
    )
...
def _stage_d4b_outputs():
    if PARTNER_MODE:
        return (
            ...
            [os.path.join(OUTPUT_DIR, "Radius_of_Gyration_Overlay.png")],
            {},
        )
    return (
        [os.path.join(OUTPUT_DIR, "Radius_of_Gyration_Protein.csv")],
        [os.path.join(OUTPUT_DIR, "Radius_of_Gyration_Protein.png")],
        {},
    )
...
def _stage_d5_outputs():
    return (
        [os.path.join(OUTPUT_DIR, "FullComplex_RMSD.csv")],
        [os.path.join(OUTPUT_DIR, "FullComplex_RMSD.png")],
        {},
    )
...
def _stage_d6_outputs():
    return (
        ...
        [
            os.path.join(OUTPUT_DIR, "DSSP_Heatmap.png"),
            os.path.join(OUTPUT_DIR, "SSE_Fractions.png"),
        ],
        {},
    )
...
def _stage_d6b_outputs():
    ...
    for label in labels:
        numerical.extend(
            [
                os.path.join(OUTPUT_DIR, f"DSSP_chain_{label}.csv"),
                os.path.join(OUTPUT_DIR, f"SSE_chain_{label}_fractions.csv"),
            ]
        )
        plots.extend(
            [
                os.path.join(OUTPUT_DIR, f"DSSP_chain_{label}_heatmap.png"),
                os.path.join(OUTPUT_DIR, f"SSE_chain_{label}_fractions.png"),
            ]
        )
