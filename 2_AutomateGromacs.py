...
#     # ============================================================
#     # 🚨 SAFETY ASSERTION — GPU UPDATE IS FORBIDDEN
#     # ============================================================
#     assert "-update gpu" not in base_cmd, (
#         "❌ FATAL CONFIG ERROR:\n"
#         "This MD pipeline forbids GPU update (-update gpu).\n"
#         "GPU update is unstable with virtual sites and must NEVER be enabled.\n"
#         "Use '-update cpu' only."
#     )
...
#     # ============================================================
#     print("\n🧩 [STEP 0] Configuring environment and CPU/GPU threading ...")
#     os.environ["GMX_NO_UPDATEGROUPS"] = "1"
